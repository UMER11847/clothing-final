  ...
  return (
    <section className="flex flex-col min-h-[900px] bg-white">
      ...
      <div className="text-center pt-[6px] pb-[4px]">
        ...
        <p
          className="text-xl text-gray-600 mt-[-12px] mb-[13px] tracking-widest pb-10"
          style={{
          ...
          <div className="relative w-[800px] h-[700px] mx-auto">
            ...
            {products[activeProduct].hotspots.map((hotspot, index) => (
              <div
                key={index}
                className={`absolute ${
                  activeHotspot !== null && activeHotspot !== index
                    ? "z-0"
                    : "z-10"
                }`}
                style={{
              ...
              >
                ...
                {/* Popup */}
                {activeHotspot === index && hotspot.detailImage && (
                  <div
                    className={`absolute ${
                      activeProduct === "Hoodie"
                        ? "left-10 top-0"
                        : "left-5 top-5"
                    } rounded-md p-[1px] z-50`}
                    style={{
                      background:
