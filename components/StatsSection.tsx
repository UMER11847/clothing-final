  ...
  return (
    <section className="w-full px-4 my-2.5 py-[22px]">
      ...
      <div className="block md:hidden">
        <div className="w-[345px] h-[142px] mx-auto bg-green-50 rounded-[10px] p-4">
          <div className="grid grid-cols-2 gap-x-8 gap-y-4 h-full">
            {/* Top row */}
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-tight">100+</div>
              <div className="text-xs text-gray-600 font-medium leading-tight">Sewing Machine</div>
            </div>

            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-tight">100k</div>
              <div className="text-xs text-gray-600 font-medium leading-tight">Garment Per Month</div>
            </div>

            {/* Bottom row */}
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-tight">21</div>
              <div className="text-xs text-gray-600 font-medium leading-tight">Contracted Brand for Manufacturing</div>
            </div>

            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-tight">•</div>
              <div className="text-xs text-gray-600 font-medium leading-tight">Certifications</div>
            </div>
          </div>
        </div>
      </div>
